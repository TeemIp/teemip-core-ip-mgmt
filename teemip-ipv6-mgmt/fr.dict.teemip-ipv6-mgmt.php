...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	'Class:IPv6Subnet/Attribute:ipconfig_ipv6_gateway_ip_format' => 'IP de la passerelle IPv6',
	'Class:IPv6Subnet/Attribute:ipconfig_ipv6_gateway_ip_format+' => '',
	'Class:IPv6Subnet/Attribute:ipconfig_ipv6_gateway_ip_format/Value:subnetip_plus_1' => 'IP du sous-réseau + 1',
	'Class:IPv6Subnet/Attribute:ipconfig_ipv6_gateway_ip_format/Value:subnetip_plus_1+' => '',
	'Class:IPv6Subnet/Attribute:ipconfig_ipv6_gateway_ip_format/Value:lastip' => 'Dernière IP du sous-réseau',
	'Class:IPv6Subnet/Attribute:ipconfig_ipv6_gateway_ip_format/Value:lastip+' => '',
	'Class:IPv6Subnet/Attribute:ipconfig_ipv6_gateway_ip_format/Value:free_setup' => 'Allocation libre',
	'Class:IPv6Subnet/Attribute:ipconfig_ipv6_gateway_ip_format/Value:free_setup+' => '',
	'Class:IPv6Subnet/Attribute:ipv6_gateway_ip_format' => 'IP de la passerelle',
